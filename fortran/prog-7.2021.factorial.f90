!   Compute n facorial using functions, subroutines & modules
!   modules are super useful for writing HPC applications
!   Programmer:  G. Luecke
...
!   integer  ::  f !  must declare type for functions if there is no
    ...
    END PROGRAM SUB_FCN_EXAMPLE

! Output
! [grl@hpc-class fortran]$ mpiifort  prog-7.module.factorial.f90 
