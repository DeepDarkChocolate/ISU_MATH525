...
! perform calculations
  call mpi_sendrecv(A(1, 1), n*n, dp, right, 1, &
       B(1, 1), n*n, dp, left, 1, &
       comm, mpi_status_ignore, ierror)
  C = matmul(A, B)
  call mpi_sendrecv(C(1, 1), n*n, dp, left, 1, &
       D(1, 1), n*n, dp, right, 1, &
       comm, mpi_status_ignore, ierror)
  if(rank > 0) then
